...
public class VGSMContentHandlerImpl {
        ...
        for (int i = 0; i < contentSize; i++) {
            ...
            for (int j = 0; j < fieldsSize; j++) {
                ...
                if(j == 4) {
                    ...
                    singleContent.add(input);
                    singleContent.add(PreBillDRQueryUtil.formatMoney((String) singleRow.get(9)));//信息费
                } else if(j == 22) {
                    singleContent.add(input);
